...
$string['pluginname'] = 'MyChildTheme';
$string['configtitle'] = 'My Child Theme';
$string['choosereadme'] = 'My Child Theme is based on the Moove theme and is a modern, highly customizable Moodle theme. Use it directly or as a base for further customization.';
...
$string['x'] = 'X URL';
$string['xdesc'] = 'Enter the URL of your X (formerly Twitter). (i.e http://www.x.com/myinstitution)';
$string['tiktok'] = 'TikTok URL';
$string['tiktokdesc'] = 'Enter the URL of your TikTok profile (e.g., https://www.tiktok.com/@myinstitution).';
