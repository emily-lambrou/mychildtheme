...
$templatecontext = [
    ...
    'headerbuttons' => \theme_mychildtheme\util\extras::get_mypublic_headerbuttons($context, $user),
    'editprofileurl' => \theme_mychildtheme\util\extras::get_mypublic_editprofile_url($user, $courseid),
